        ...
        <>
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-40 md:hidden">
                    ...
                    {/* Mobile Menu */}
                    <div className="fixed top-[73px] right-0 w-80 max-w-[90vw] h-[calc(100vh-73px)] bg-white dark:bg-apple-gray-900 shadow-xl border-l border-apple-gray-200 dark:border-apple-gray-800">
    ...
    return (
        <footer className="bg-apple-gray-100 dark:bg-black/20">
            <div className="container mx-auto px-6 py-8 text-center text-sm text-apple-gray-500 dark:text-apple-gray-400">
                <p>&copy; {new Date().getFullYear()} PressFlow. {t('public.footer.allRightsReserved')}</p>
